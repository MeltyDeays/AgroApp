...
export default StyleSheet.create({
  ...
  buttonApprove: { backgroundColor: COLORES.verde },
  buttonApproveText: { color: COLORES.blanco },
  buttonReject: {
    backgroundColor: COLORES.fondo,
    borderWidth: 1,
    borderColor: COLORES.rojo,
  },
  buttonRejectText: { color: COLORES.rojo },
  buttonUpdate: {
    backgroundColor: COLORES.fondo,
    borderWidth: 1,
    borderColor: COLORES.primario,
  },
  buttonUpdateText: { color: COLORES.primario },
  buttonStart: { backgroundColor: COLORES.primario },
  buttonStartText: { color: COLORES.blanco },
  ...
  editButton: { backgroundColor: "#DBEAFE", borderColor: "#93C5FD" },
  deleteButton: { backgroundColor: "#FEE2E2", borderColor: "#FCA5A5" },
  cardButtonText: { fontSize: 13, fontWeight: "500", marginLeft: 6 },
  ...
  imagePickerButtonText: { color: COLORES.primario, fontWeight: "600" },
  imagePreview: {
    width: "100%",
    height: 200,
    borderRadius: 8,
  ...
  maintButton: { backgroundColor: "#FEF9C3", borderColor: "#FDE047" },
  maintButtonText: { color: "#A16207" },
  tabBar: {
  ...
  tabIndicator: { height: 3, backgroundColor: COLORS.primary, borderRadius: 3 },
  tabLabel: { fontWeight: "600", color: COLORS.textSecondary },
  card: {
    borderRadius: 16,
    backgroundColor: "#FFFFFF",
    overflow: "hidden",
  ...
  modalButton: { borderRadius: 12, paddingVertical: 10, paddingHorizontal: 14 },
  ...
  modalButtonTextConfirm: { color: "#FFFFFF" },
  ...
  picker: { height: 44, width: "100%", backgroundColor: "transparent" },
  sortRow: { flexDirection: "row", justifyContent: "space-between", gap: 12 },
  sortButton: {
    flex: 1,
    flexDirection: "row",
    alignItems: "center",
  ...
  statValueGreen: { fontSize: 24, fontWeight: "bold", color: "#10B981" },
  statValueYellow: { fontSize: 24, fontWeight: "bold", color: "#F59E0B" },
  statValueRed: { fontSize: 24, fontWeight: "bold", color: "#EF4444" },
  statLabel: {
    fontSize: 12,
  ...
  solicitudUser: { fontSize: 14, color: COLORS.textSecondary, marginTop: 4 },
  solicitudSector: {
    fontSize: 14,
    color: COLORS.textSecondary,
    marginTop: 2,
  ...
  solicitudDates: { fontSize: 14, color: COLORS.textSecondary, marginTop: 2 },
  solicitudActions: {
    flexDirection: "row",
    justifyContent: "flex-end",
    marginTop: 16,
